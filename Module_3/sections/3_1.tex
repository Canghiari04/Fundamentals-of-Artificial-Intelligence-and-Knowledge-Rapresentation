...
\begin{example}
    ...
    \begin{center}
        $P(GreenerGrass|Sprinkler=True)$ = ?\ownfootnote{Here, we are observing that Sprinkler is on.}
    ...
    \begin{center}
        $P(c, r, w, g|do(S = true))$\ownfootnote{Instead, we are turning Sprinkler on to see what happens.}
    \end{center} \vspace{3.5pt}
