...
\begin{itemize}[nosep]
    \renewcommand{\labelitemi}{-}
    \item \textbf{Goal stack}. \\ A FIFO queue, so First In First Out data structure, initialized with the goals to be achieved and proceeding backward.
...
\begin{example}
    ...
    \begin{itemize}[nosep]
        ...
        \begin{center}
            ...
            \end{tabular}
        \end{center} \vspace{3.5pt}
        None of the $\mathbf{stack(c,b)}$ preconditions are satisfied by the current state, they become the new subgoals to achieve. \vspace{3.5pt}
        \begin{center}
            \begin{tabular}{ll}
                \textbf{State} & \textbf{Goal stack} \\
